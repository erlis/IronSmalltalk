...
namespace IronSmalltalk.Console
{
    public class Program
    {
        ...
        private static void RunConsole()
        {
            ...
            System.Console.WriteLine("IronSmalltalk v0.1");
            ...
            while (true)
            {
                ...
                try
                {
                    System.Console.WriteLine(RunProgram(engine, command, globals));
                }
                catch (Exception ex)
                {
        ...
        private static void ObjectTest()
        {
            ...
            System.Console.WriteLine(ch.SendMessage(new SmallSymbol("#value")));
            System.Console.WriteLine(ch.SendMessage(new SmallSymbol("#asLowercase")));
        }
        ...
        private static void LexerTest()
        {
            ...
            while (!tokens.AtEnd)
            {
                System.Console.WriteLine(tokens.Read());
            }
        }
